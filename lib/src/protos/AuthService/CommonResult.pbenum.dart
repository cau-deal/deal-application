...
class ResultCode extends $pb.ProtobufEnum {
  static const ResultCode UNKNOWN_RESULT_CODE = ResultCode._(0, 'UNKNOWN_RESULT_CODE');
  static const ResultCode SUCCESS = ResultCode._(1, 'SUCCESS');
  static const ResultCode ERROR = ResultCode._(2, 'ERROR');
