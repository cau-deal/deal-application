            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(child: RaisedButton(
                    color: (state is Verified && state.phoneVerified)? Color(0xffF7CF00) : Color(0xffe0e0e0),
                    elevation: 0,
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Text('포인트 충전', style: TextStyle(color: Colors.black87, fontSize: 13, fontWeight: FontWeight.w500, fontFamily: "NanumSquare"))
                      ],
                    )
                )),
                SizedBox(width: 10),
                Expanded(child: RaisedButton(
                    color: (state is Verified && state.accountVerified)? Color(0xffF7CF00) : Color(0xffe0e0e0),
                    elevation: 0,
                    highlightElevation: 0,
                    onPressed: (){
                      if(state is Verified && state.accountVerified){
