  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Theme(
        data: ThemeData(
            textTheme: TextTheme(
                subhead: TextStyle(color: Colors.black, fontFamily: "NanumSquare")
            ),
            dividerColor: Colors.white,
            accentColor: Colors.black
        ),

        child: BlocListener<InquiryHistoryBloc, InquiryHistoryState>(
            listener: (ctx, state){
              if( state is InquiryLoaded ){
              }
            },
            child: BlocBuilder<InquiryHistoryBloc, InquiryHistoryState>(
                builder: (ctx, state){
