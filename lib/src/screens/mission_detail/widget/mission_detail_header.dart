                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            Text("100 / 10 건", style: TextStyle(letterSpacing:-0.5, fontSize: 15, color: Color(0xff333333),))
                          ],
                        ),
                      ],
                    ),
                  ...
                  children: <Widget>[
                    Row(
                      children: <Widget>[
                        ...
                        SizedBox(width: 5),
                        Text("~2019.10.13", style: TextStyle(letterSpacing:-0.8, color: Color(0xFF5f75ac),)),
                        SizedBox(width: 5),
                        Badge(text: "1일",),
                        SizedBox(width: 5),
                        Badge(text: "수집",)
                    ...
                    GestureDetector(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Text("신고하기", style: TextStyle(letterSpacing:-0.5, fontSize: 12, color: Color(0xff333333),))
                        ],
                      )
                    ),
                  ],
